...
var chess = (function() {
	...
	// DOM
	oPGNBtn, oMovesSelect, oInfoBox, oCtrlForm, oNtfArea = null, oNtfClsAll = null, bInfoBox = false, aCloseCalls = [], iNtfs = 0, rDeniedTagChrs = /(^\d)|\W/g, sAlgBoxEmpty = "Sherlock your move...", bCtrlIsDown = false,
	...
	oGameInfo = {}, oNewInfo = {}, etc = { // do not change theese values!!
		...
		isValidMove: function(nPosX, nPosY, nTargetX, nTargetY) {
			...
			console.log("npieceType: " + nPieceType);
			switch (nPieceType) {
				case 1: // pawn
				    chessPieceType = 1;
	...
	*/
	function writeHistory(bGraphRendrng, nStartPt, nEndPt, nPieceId, nTarget, nPromo) {
		...
		console.log("chessPieceType " + chessPieceType);
		console.log("Valid move! You may have a clue!");
		/*
        document.getElementById("myaudio").setAttribute("src", "../audio/Fibonacci-0" + chessPieceType + ".ogg");
        document.getElementById("myaudio").play();
		*/
		
		// document.getElementById('youtube').setAttribute("style", "display:block;position:absolute;left:100px;top:100px;z-index:120;");
		showClueContainer(chessPieceType);
		iHistPointr++;
	}
...
// DOM private APIs
	...
	function getCtrlDown(oKeyEvnt2) { if (oKeyEvnt2.keyCode === 17) { bCtrlIsDown = true; console.log("Key Down");} }
